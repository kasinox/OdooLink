...
public class Vendor extends Table{
	...
	public void init(){
		...
		addColumn("VendorAddressAddr1","String","name",true,true);
		addColumn("VendorAddressAddr2","String","street",true,true);
		addColumn("VendorAddressAddr3","String","street2",true,true);
		addColumn("VendorAddressCity","String","city",true,true);
		addColumn("VendorAddressState","String","state",true,true);
		addColumn("VendorAddressProvince","String","state",true,true);
		addColumn("VendorAddressCounty","String","country",true,true);
		addColumn("VendorAddressPostalCode","String","zip",true,true);
		addColumn("VendorAddressNote","String","",true,true);
...
//		addColumns(entrySet);
	...
	public String printVendorValue(){
		String text ="";
